...
[![Current Version](https://img.shields.io/badge/version-1.0.7-green.svg)](https://github.com/soumanpaul/MERN-e-commerce)
...
[![GitHub Stars](https://img.shields.io/github/stars/soumanpaul/node-chat.svg)](https://github.com/soumanpaul/MERN-e-commerce/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/soumanpaul/node-chat.svg)](https://github.com/soumanpaul/MERN-e-commerce/issues)  
...
---
## Demo 
[![Live Demo](https://img.shields.io/badge/demo-online-green.svg)](http://marketplace24client.herokuapp.com/)
...
## Features
  - [x] Sign up: Users can register by creating a new account using an email address
  - [x] User list: Any visitor can see the list of all registered users
  - [x] Authentication: Registered users can sign in and sign out
  - [x] Protected user profile: Only registered users can view individual user
details after signing in
  - [x] Authorized user edit and delete: Only a registered and authenticated user
can edit or remove their own user account details
  - [x] Users with seller accounts
  - [x] Shop management
